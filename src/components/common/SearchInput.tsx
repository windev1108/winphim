...
const SearchInput = forwardRef<HTMLDivElement, ISearchInputProps>(({ inputBaseClassName, containerClassName, inputProps, placeholder = "Tìm kiếm phim, diễn viên, đạo diễn...", value, onChangeValue, onClearValue, onSearch, ...props }, ref) => {
    return (
        <div className={cn("relative w-full", containerClassName)} ref={ref} {...props}>
            ...
            <Input
                ...
                className={cn("w-full pl-10 pr-10 h-10 bg-zinc-900 border-secondary-800 text-white placeholder:text-secondary-200 primary focus:ring-1 focus:ring-transparent transition-all rounded-lg text-base", inputBaseClassName)}
            />
            {value && (
                <button
